    ...
    return (
      <>
        {/*
          ...
          ```
        */}
        <main className="relative bg-white lg:min-h-full">
          ...
          <div>
            <div className="max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
              <div className="lg:col-start-2">
                <h1 className="text-sm mt-4 font-medium text-indigo-600">Payment successful</h1>
