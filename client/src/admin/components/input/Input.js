    ...
    return (
        <div class="relative z-0 mb-6 w-full group px-96">
            ...
            <div className="flex justify-center">
              {isCreated ? <button  onClick={() => {APIadd(`/api/admin/add`,values); setEdit('home');}} class="mx-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Créer l'article</button> : <button  onClick={() =>  APIupdate(`/api/admin/update/${dataTochange.id}`,values, setEdit)} class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Enregistrer les changements</button>}
